...
\noindent\faBookmarkO~\textit{\textbf{Luyện tập 1:}}
...
\noindent\faBookmarkO~\textit{\textbf{Luyện tập 2:}}
...
\begin{luyentap}
    Giải hệ phương trình $\heva{&4x + 3y = 6 \\ &-5x + 2y = 4}$ bằng\\
    phương pháp cộng đại số.
    %%%
    \doicot
    %%%
...
\begin{vidu}
    Giải hệ phương trình $\heva{&3x - 5y = 2 \\ &-6x + 10y = -4}$ bằng\\
    phương pháp cộng đại số.
    %%%
    \doicot
    %%%
...
\noindent\faBookmarkO~\textit{\textbf{Luyện tập 4}}
...
\noindent\faBookmarkO~\textit{\textbf{Ví dụ 6}}
...
\noindent\faBookmarkO~\textit{\textbf{Luyện tập 5}}
...
\begin{vandung}
    ...
    %%%
    \begin{listEX}
        \item $\heva{&x+y=600\\&0{,}6}x+0{,}65y=413.$
...
\begin{dhnh}
    ...
    \begin{itemize}
        \item \textit{Bước 1.} Vào chức năng giải hệ hai phương trình bậc nhất hai ẩn bằng cách bấm các phím \fbox{MODE} \fbox{5} \fbox{1} (xem \textit{màn hình sau bước 1}, con trỏ ở vị trí $a_1$).
        \item \textit{Bước 2.} Nhập các số $a_1 = 2, b_1 = 3, c_1 = 4; a_2 = 5, b_2 = 6$ và $c_2 = 7$ bằng cách bấm: \\
        \fbox{2} \fbox{=} \fbox{3} \fbox{=} \fbox{4} \fbox{=} \fbox{5} \fbox{=} \fbox{6} \fbox{=} \fbox{7} \fbox{=} (xem \textit{màn hình sau bước 2}).
        \item \textit{Bước 3.} Đọc kết quả: Sau khi kết thúc bước 2, bấm \fbox{=}, màn hình cho $x = -1$; bấm tiếp phím \fbox{=}, màn hình cho $y = 2$ (xem \textit{màn hình sau bước 3}). Ta hiểu nghiệm của hệ phương trình là $(-1; 2)$.
    \end{itemize}
    %%%
    \doicot
    %%%
    \begin{itemize}
        \item \textit{Bước 1.}\\
        \includegraphics[width=5.5cm]{imgs/9D1-2-casio-1.png}
        \item \textit{Bước 2.}\\
        \includegraphics[width=5.5cm]{imgs/9D1-2-casio-2.png}
        \item \textit{Bước 3.}\\
        \includegraphics[width=5.5cm]{imgs/9D1-2-casio-3.png}
    \end{itemize}
\end{dhnh}
...
\noindent\faBookmarkO~\textit{\textbf{Vận dụng 3:}}
...
\noindent\faBookmarkO~\textit{\textbf{Phiếu học tập 1:}}
...
\textit{(Dùng chung cho các bài tập từ 1.6 đến 1.9)}
...
\subparagraph{Phiếu học tập số 1}
...
\subparagraph{Phiếu học tập số 2}
...
\begin{bt}
    ...
    \end{center}
    \begin{itemize}
        \item \textit{Bước 1.} Từ một phương trình của hệ, \makebox[3cm]{\dotfill} một ẩn theo ẩn kia rồi \makebox[3cm]{\dotfill} vào phương trình còn lại của hệ để được phương trình chỉ còn chứa \makebox[3cm]{\dotfill} ẩn.
        \item \textit{Bước 2.} Giải phương trình \makebox[3cm]{\dotfill} vừa nhận được, từ đó suy ra \makebox[3cm]{\dotfill} của hệ đã cho.
    \end{itemize}
\end{bt}
...
\begin{bt}
    ...
    \begin{itemize}
        \item \textit{Bước 1.} \makebox[3cm]{\dotfill} hay \makebox[3cm]{\dotfill} từng vế của hai phương trình trong hệ để được phương trình chỉ còn chứa \dots\dots\dots\dots\dots\dots .
        \item \textit{Bước 2.} Giải phương trình \makebox[3cm]{\dotfill} vừa nhận được, từ đó suy ra \makebox[3cm]{\dotfill} của hệ đã cho.
    \end{itemize}
\end{bt}
