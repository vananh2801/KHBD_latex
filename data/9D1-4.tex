...
\begin{itemize}
	\item Tiết 1: Giải bài toán bằng cách lập hệ phương trình.
	\item Tiết 2: Chữa bài tập.
\end{itemize}
...
\begin{tcth}
	...
	\begin{nhanxet}
		...
		\begin{itemize}[leftmargin=10pt]
			...
			\end{itemize}
			\item \textit{Bước 2.} Giải hệ phương trình.
			\item \textit{Bước 3.} Trả lời: Kiểm tra xem trong các nghiệm tìm được của hệ phương trình, nghiệm nào thoả mãn, nghiệm nào không thoả mãn điều kiện của ẩn, rồi kết luận.
		\end{itemize}
	\end{nhanxet}
\end{tcth}
...
\begin{baitap}[1.16]
	...
	\begin{center}
		\begin{tabular}{|l|c|c|c|c|c|}
			\hline
			\makecell{Điểm số của\\mỗi lần bắn} & 10 & 9 & 8 & 7 & 6 \\ \hline
...
\textit{(Dùng chung cho các bài tập từ 1.15 đến 1.18)}
