...
\begin{itemize}
	\item Tiết 1: Ôn tập lí thuyết. Các bài tập trắc nghiệm và một số bài tập tự luận.
	\item Tiết 2: Các bài tập tự luận cuối chương.
\end{itemize}

\subsubsection{Ôn tập lí thuyết. Các bài tập trắc nghiệm và một số bài tập tự luận.}
...
\begin{ontap}
	...
	\begin{listEX}
		\item hệ phương trình bậc nhất hai ẩn và các\\
		phương pháp giải;
...
\textit{(Dùng chung cho các bài tập từ 1.19 đến 1.22)}
...
\textit{(Dùng chung cho các bài tập từ 1.23 đến 1.24)}
...
\textit{(Dùng chung cho các bài tập từ 1.25 đến 1.28)}
